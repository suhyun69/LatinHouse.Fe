  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-white/10 bg-black/80 backdrop-blur-md px-6 md:px-10 py-4">
      ...
      <div className="flex flex-1 justify-end gap-6">
        <label className="hidden lg:flex flex-col min-w-40 h-10 w-full max-w-[280px]">
          <div className="flex w-full flex-1 items-stretch rounded-full bg-zinc-900 border border-zinc-800 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all">
            <div className="text-zinc-500 flex items-center justify-center pl-4">
              <span className="material-symbols-outlined text-[20px]">search</span>
            </div>
            <input
              className="flex w-full min-w-0 flex-1 bg-transparent border-none focus:ring-0 text-sm px-3 text-text-main placeholder:text-zinc-600"
